...
/**
 * @fileOverview Summarizes a conversation with Sakhi about a health topic.
 *
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are Sakhi, a helpful AI assistant for women's health. Please summarize the following conversation:

{{{conversationText}}}

Summary:`, // Corrected typo here
});
