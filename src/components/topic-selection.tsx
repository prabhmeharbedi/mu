    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-background p-4">
      <div className="text-center mb-12">
        <div className="flex justify-center items-center gap-3 mb-4">
          <SakhiLogo />
          <h1 className="font-headline text-5xl text-primary">Sakhi AI</h1>
        </div>
        <p className="font-body text-xl text-muted-foreground max-w-md mx-auto">
          Hello, I'm Sakhi, your personal AI companion. How can I help you today?
        </p>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-5xl">
        {topics.map((topic) => (
          <Card
            ...
            className="cursor-pointer hover:shadow-lg hover:-translate-y-1 transition-transform duration-300 ease-in-out group bg-card"
          >
